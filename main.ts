...
let variable = scene.createRenderable(zLayer1, (image1: Image, camera: scene.Camera) => {
    ...
    helpers.imageBlit(screenClone, (tempImg.width - 160) / -2, (tempImg.height - 120) / -2, tempImg.width, tempImg.height, tempImg, 0, 0, tempImg.width, tempImg.height, true, false)
